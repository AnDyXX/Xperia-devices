	 ...
	 int (*okfn)(struct sk_buff *))
{
	return ipt_do_table(skb, hook, in, out,
			    ...
			    init_ax8netfilter_net.ipv4.iptable_raw);
#else
...
static int __net_init iptable_raw_net_init(struct net *net)
{
	...
	if (IS_ERR(init_ax8netfilter_net.ipv4.iptable_raw))
		return PTR_ERR(init_ax8netfilter_net.ipv4.iptable_raw);
#else
...
{
#ifdef CONFIG_AX8_NETFILTER
	ipt_unregister_table(init_ax8netfilter_net.ipv4.iptable_raw);
#else
