...
restart:
		...
		hlist_for_each_entry_rcu(h, n, &init_ax8netfilter_net.ct.hash[cb->args[0]],
#else
...
restart:
#ifdef CONFIG_AX8_NETFILTER
		hlist_for_each_entry(exp, n, &init_ax8netfilter_net.ct.expect_hash[cb->args[0]],
#else
...
#ifdef CONFIG_AX8_NETFILTER
						  &init_ax8netfilter_net.ct.expect_hash[i],
#else
