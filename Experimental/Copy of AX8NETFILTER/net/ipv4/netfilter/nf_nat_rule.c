		     ...
		     struct nf_conn *ct)
{
	...
	ret = ipt_do_table(skb, hooknum, in, out, init_ax8netfilter_net.ipv4.nat_table);
#else
...
{
#ifdef CONFIG_AX8_NETFILTER
	init_ax8netfilter_net.ipv4.nat_table = ipt_register_table(net, &nat_table,
						 &nat_initial_table.repl);
	if (IS_ERR(init_ax8netfilter_net.ipv4.nat_table))
		return PTR_ERR(init_ax8netfilter_net.ipv4.nat_table);
	return 0;
#else
...
{
#ifdef CONFIG_AX8_NETFILTER
	ipt_unregister_table(init_ax8netfilter_net.ipv4.nat_table);
#else
