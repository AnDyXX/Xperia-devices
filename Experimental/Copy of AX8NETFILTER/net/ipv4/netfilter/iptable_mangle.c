		     ...
		     int (*okfn)(struct sk_buff *))
{
	return ipt_do_table(skb, hook, in, out,
			    ...
			    init_ax8netfilter_net.ipv4.iptable_mangle);
#else
...
static int __net_init iptable_mangle_net_init(struct net *net)
{
	...
	if (IS_ERR(init_ax8netfilter_net.ipv4.iptable_mangle))
		return PTR_ERR(init_ax8netfilter_net.ipv4.iptable_mangle);
#else
	/* Register table */
...
{
#ifdef CONFIG_AX8_NETFILTER
	ipt_unregister_table(init_ax8netfilter_net.ipv4.iptable_mangle);
#else
