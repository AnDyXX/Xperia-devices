 ...
 */
#ifdef EXTERNAL_SWAP_MODULE
void ax8swap_page_add_anon_rmap(struct page *, struct vm_area_struct *, unsigned long);
#define page_add_anon_rmap(p, s, i)  ax8swap_page_add_anon_rmap(p, s, i) 

void ax8swap_page_add_new_anon_rmap(struct page *, struct vm_area_struct *, unsigned long);
#define page_add_new_anon_rmap(p, v, i) ax8swap_page_add_new_anon_rmap(p, v, i)

void ax8swap_page_add_file_rmap(struct page *);
#define page_add_file_rmap(p) ax8swap_page_add_file_rmap(p)

void ax8swap_page_remove_rmap(struct page *p);
#define page_remove_rmap(p) ax8swap_page_remove_rmap(p)
 ...
 */
#ifdef EXTERNAL_SWAP_MODULE
unsigned long ax8swap_page_address_in_vma(struct page *, struct vm_area_struct *);
#define page_address_in_vma(page, vm) ax8swap_page_address_in_vma(page, vm)
#else
