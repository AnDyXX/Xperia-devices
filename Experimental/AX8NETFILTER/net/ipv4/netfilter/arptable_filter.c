				 ...
				 int (*okfn)(struct sk_buff *))
{
	return arpt_do_table(skb, hook, in, out,
			     ...
			     init_ax8netfilter_net.ipv4.arptable_filter);
#else
...
static int __net_init arptable_filter_net_init(struct net *net)
{
	...
	if (IS_ERR(init_ax8netfilter_net.ipv4.arptable_filter))
		return PTR_ERR(init_ax8netfilter_net.ipv4.arptable_filter);
#else
...
{
#ifdef CONFIG_AX8_NETFILTER
	arpt_unregister_table(init_ax8netfilter_net.ipv4.arptable_filter);
#else
