/*
 *  based on drivers/cpufreq/cpufreq_ondemand.c
 *
...
MODULE_AUTHOR("AnDyX <andyx@xda-developers.com>");
MODULE_DESCRIPTION("'cpufreq_ondemand' based governor");
MODULE_LICENSE("GPL");
